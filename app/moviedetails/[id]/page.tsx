...
import { Calendar, Clock, Star, Play, ArrowLeft, Camera } from "lucide-react";
...
export default async function MovieDetailsPage({ params }: PageProps) {
        ...
        return (
            <div className="min-h-screen bg-[#050505] flex items-center justify-center text-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 mb-8">Movie not found.</p>
    ...
    const runtimeStr = runtime > 0 ? `${Math.floor(runtime / 60)}h ${runtime % 60}m` : 'N/A';

    // Extract Certification
    const releaseDates = movie.release_dates?.results?.find((r: any) => r.iso_3166_1 === 'US')?.release_dates;
    const certification = releaseDates ? releaseDates[0]?.certification : null;
                    ...
                    <div className="container mx-auto px-6 flex flex-col md:flex-row gap-8 items-end">
                        ...
                        <div className="flex-1 space-y-6 max-w-4xl">
                            ...
                            <div className="flex flex-wrap items-center gap-3 pt-4 w-full sm:w-auto">
                                ...
                                {/* Photos Button */}
                                <Link
                                    href={`/movie/${movieId}/${title.replace(/[^a-z0-9]+/gi, '-').toLowerCase()}/photos`}
            ...
            <div className="container mx-auto px-6 py-16 space-y-16">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <aside className="w-full lg:w-80 lg:shrink-0">
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                                <div>
                                    <h3 className="text-gray-400 text-xs uppercase tracking-widest font-bold mb-2">Director</h3>
                ...
                <section>
                    <Suspense fallback={<div className="h-64 rounded-xl bg-white/5 animate-pulse" />}>
                        <RecommendedMovies movieId={movieId} mediaType={movie.media_type} />
                    </Suspense>
                </section>
